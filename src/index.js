...
document.querySelector("#main_for").innerHTML = "цикл for - " + tmp_total_for;
document.querySelector("#main_while").innerHTML =
  "цикл while - " + tmp_total_while;
document.querySelector("#main_function").innerHTML =
  "function - " + tmp_total_func;
document.querySelector("#main_arrowFunc").innerHTML =
  "arrow multiply function - " + multiply();
// Log to console
